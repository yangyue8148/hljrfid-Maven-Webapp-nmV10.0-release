...
public class EquipInfoMapper {
    ...
    private TaskEquip taskEquip ;
    
    
    public TaskEquip getTaskEquip()
    {
    	return taskEquip ;
    }
    
    public void setTaskEquip(TaskEquip taskequip)
    {
    	this.taskEquip = taskequip ;
    }
