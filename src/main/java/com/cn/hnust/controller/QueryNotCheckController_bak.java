...
public class QueryNotCheckController_bak {
	...
	private Map<String, Object> map_exestatusMap = new HashMap<String, Object>() ;

	@SuppressWarnings("null")
	@RequestMapping(value = "/user/queryNotCheck-bak")
